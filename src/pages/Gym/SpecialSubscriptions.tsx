...
const SpecialSubscriptions = () => {
  ...
  // جلب الأعضاء لاستخدامهم كعملاء في الاشتراك الخاص
  const { data: membersData } = useGetAllMembersQuery({} as any);
  const members = Array.isArray(membersData?.data) ? membersData.data : [];

  // جلب الاشتراكات الخاصة من API (نستخدم نفس API لكن مع isSpecial = true)
  ...
  // جلب الإحصائيات (للاشتراكات الخاصة فقط)
  const { data: statisticsData } = useGetSubscriptionStatisticsQuery({ isSpecial: true } as any);
  ...
  const generateReceiptNumber = (): string => {
    ...
    return `SPC-${year}${month}${day}-${random}`;
  };
  ...
  // تحويل string (dd/mm/yyyy) إلى yyyy-mm-dd
  ...
  const calculateEndDateByDays = (start: Date | undefined, days?: number | string): Date | undefined => {
    ...
    // نضيف (عدد الأيام - 1) ليكون يوم البدء ضمن المدة
  ...
  const handleSaveAdd = async () => {
    ...
    try {
      ...
      toast({
        title: "نجح",
        description: "تم إضافة الاشتراك الخاص بنجاح"
      });
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      toast({
        title: "نجح",
        description: "تم تحديث الاشتراك الخاص بنجاح"
      });
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast({
        title: "نجح",
        description: "تم حذف الاشتراك الخاص بنجاح"
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-cyan-50/20 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">إدارة الاشتراكات الخاصة</h1>
            <p className="text-gray-600 mt-1">إدارة الاشتراكات الخاصة والمدفوعات</p>
          </div>
          ...
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              <span className="flex items-center gap-2">
                ...
                قائمة الاشتراكات الخاصة ({filteredSubscriptions.length})
              </span>
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        {/* Dialog إضافة اشتراك خاص جديد */}
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>إضافة اشتراك خاص جديد</DialogTitle>
              <DialogDescription>
                أدخل جميع بيانات الاشتراك الخاص الجديد
              </DialogDescription>
            </DialogHeader>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>تعديل الاشتراك الخاص</DialogTitle>
              <DialogDescription>
                قم بتعديل بيانات الاشتراك الخاص
              </DialogDescription>
            </DialogHeader>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
